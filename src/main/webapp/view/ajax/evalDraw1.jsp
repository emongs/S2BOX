...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/common/css/S2_BOX_khj.css">

<script>
function loadEval(name,flagP){
	var movie_name=name;
	var flag = flagP;
	...
	alert(movie_name);
	alert(flag);
	var params = "movie_name=" + encodeURIComponent(movie_name) + "&flag="+encodeURIComponent(flag);
...
<script>
	...
	function show3(star1) {
		...
		if (star1 <= 0.5) {
			...
			el =document.getElementsByClassName('image21');
			el.src = tempimg;	
	}
</script>
			...
			<div id="tab1" class="container comm_tab2">
				...
				<div class="jq_cont tab_cont">
					...
					<div class="tab_container">
						<table>
										<tr>
											<td><iframe src="<%=request.getContextPath()%>/chart/chart.combo-bar-line.jsp"></iframe></td>
										</tr>
									</table>
					</div>
					<!-- 탭1-1// -->
					...
					<div class="tab_container">
						<table>
										<tr>
											<td><iframe src="<%=request.getContextPath()%>/chart/pie.jsp"></iframe></td>
										</tr>
									</table>
					</div>
					<!-- 탭1-2// -->
				...
				<div class="jq_cont tab_cont">
					...
					<div class="tab_container">
						...
						<p>
							...
							<br> 예: 소심한 사람에게 혈액형을 물어 A형이 아니라고 하면 금방 잊어버리고,<br> A형이
							맞다고 하면 호들갑을 떨며 "맞지? A형일것 같았어."라고 말하는 것.
						</p>
					</div>
					<!-- 탭1-1// -->
					<!-- //탭1-2 -->
					<div class="tab_container">
						...
						외향적인 성격이지만 때때로 소심하거나 내향적인 모습을 보이기도 한다"와 같은 당연한 소리를 자신의 성격이라고 믿는 것.
		...
		<div id="orderCheckbox" class="top_behavior"
			...
			<ul class="sorting_list"
				...
				<li style="float: left;"><a href="#"
					onclick="loadEval('${movie_name}',1);"
					style="margin-right: 16px; color: #666; text-decoration: none; font-family: '나눔고딕', NanumGothic;">호감순</a></li>
				<li style="float: left;"><a href="#"
					onclick="loadEval('${movie_name}',2);"
					style="margin-right: 16px; color: #666; text-decoration: none; font-family: '나눔고딕', NanumGothic;">최신순</a></li>
				<li style="float: left;"><a href="#"
					onclick="loadEval('${movie_name}',3);"
					style="margin-right: 16px; color: #666; text-decoration: none; font-family: '나눔고딕', NanumGothic;">
						평점 높은 순</a></li>
				<li style="float: left;"><a href="#"
					onclick="loadEval('${movie_name}',4);"
