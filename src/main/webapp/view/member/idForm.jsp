		...
		<div class="seaTabs_content">
			<div class="seaTabs_item seaTabs_content_active">
				...
				<form action="<%=request.getContextPath()%>/member/id" method="post">
					<div class="container">
						<br> <br> <br> <label><b> 이름</b></label> <input
							type="text" name="name" class="login" required> <br>
						<label><b>휴대폰 번호</b></label> <select name="mobile1">
			...
			<div class="seaTabs_item">
				...
				<form action="<%=request.getContextPath()%>/member/password"
					method="post">
					<div class="container">
						<br> <br> <br> <label><b>아이디&nbsp;&nbsp;&nbsp;
						</b></label> <input type="text" name="id" class="login" required> <br>
						<label><b> 이름&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></label> <input
							type="text" name="name" class="login" required> <br>
