...
<div style="margin-bottom: 10px; margin-left: 22%;  margin-right: 10%; word-spacing:20px;">
		...
		<a style="color:#000;" href="<%=request.getContextPath()%>/board/list2?boardid=5"
			class="">전체</a>&nbsp;&nbsp; <a style="color:#000;"
			href="<%=request.getContextPath()%>/board/list2?boardid=6"
			class="">시스템점검</a> &nbsp;&nbsp;<a style="color:#000;"
			href="<%=request.getContextPath()%>/board/list2?boardid=7"
			class="">극장</a>&nbsp;&nbsp; <a style="color:#000;"
			href="<%=request.getContextPath()%>/board/list2?boardid=8"
			class="">기타</a>
