...
<body>
<jsp:include page="movieFinder.jsp" />
<div class="movieFinder_container">
		...
		<c:forEach var = "a" begin="0" end="${size-1}">
				...
				<td class="movieTable_td">
					 <li>
                    <div>
                        <a href="movieNameToDetail?movieNm=${li[a].movieNm}&genre=${li[a].genre}&nations=${li[a].nations}">
                            <span>
                    ...
                    <div>
                       ...
                       <div>
                        ...
                        <span> 
                            ...
                            <br><!-- 영화이름으로 대체 -->
                            <span class="count"> 
                                <strong><i>zzz</i><span>명이 선택</span></strong> 
                            </span>
                            <a href="#">예매</a>
                        </span>
                    </div>    
